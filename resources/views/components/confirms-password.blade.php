@props(['title' => __('Potvrdi lozinku'), 'content' => __('Radi vaše sigurnosti, potvrdite lozinku za nastavak.'), 'button' => __('Potvrdi')])
...
<x-dialog-modal wire:model="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <x-input type="password" class="mt-1 block w-3/4" placeholder="{{ __('Lozinka') }}" autocomplete="current-password"
