...
$classes = ($active ?? false)
            ? 'block w-full pl-3 pr-4 py-2 border-l-4 border-indigo-900 text-left text-base font-medium text-indigo-700 bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700 transition duration-150 ease-in-out'
...
<?php /**PATH C:\Users\Korisnik\Desktop\Sapice\resources\views/components/responsive-nav-link.blade.php ENDPATH**/ ?>