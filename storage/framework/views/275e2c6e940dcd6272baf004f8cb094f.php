...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Sesije preglednika')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Upravljajte i odjavite se svojim aktivnim sesijama na drugim preglednicima i uređajima.')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600">
            <?php echo e(__('Ako je potrebno, možete se odjaviti sa svih ostalih sesija preglednika na svim svojim uređajima. Neke od vaših nedavnih sesija navedene su u nastavku; međutim, ovaj popis možda nije konačan. Ako smatrate da je vaš račun ugrožen, također biste trebali ažurirati svoju lozinku.')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <div class="text-sm text-gray-600">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : __('Nepoznat')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('Nepoznat')); ?>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    <?php if($session->is_current_device): ?>
                                        <span class="text-green-500 font-semibold"><?php echo e(__('Ovaj uređaj')); ?></span>
                                    <?php else: ?>
                                        <?php echo e(__('Zadnji aktivam')); ?> <?php echo e($session->last_active); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('Unesite svoju zaporku kako biste potvrdili da se želite odjaviti iz ostalih sesija preglednika na svim svojim uređajima.')); ?>


                <div class="mt-4" x-data="{}" x-on:confirming-logout-other-browser-sessions.window="setTimeout(() => $refs.password.focus(), 250)">
                    <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('Lozinka')).'','xRef' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','autocomplete' => 'current-password','placeholder' => ''.e(__('Lozinka')).'','x-ref' => 'password','wire:model.defer' => 'password','wire:keydown.enter' => 'logoutOtherBrowserSessions']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\Users\Korisnik\Desktop\Sapice\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>